...
STORE_STORES = ['ALDO Centre Eaton', 'ALDO Destiny USA Mall',
...
SHOES_MODELS = %w[ADERI MIRIRA CAELAN BUTAUD
                  SCHOOLER SODANO MCTYRE CADAUDIA
                  RASIEN WUMA GRELIDIEN CADEVEN SEVIDE
                  ELOILLAN BEODA VENDOGNUS ABOEN
                  ALALIWEN GREG BOZZA].freeze
